...
public class DataFeederLoader {
     ...
     * @param parameterNames is null - then generated names will be used -, or the parameter names to be used.
     * @return with the parameters for a test class run
     */
    public DataDrivenParameters getParameterRow(final String className, final int drivenDataRowNo, final String[] parameterNames) {
        //first get the row
        ...
        DataDrivenParameters paramRow = new DataDrivenParameters(p, (parameterNames == null) ? parameterArray.getParameterNames() : parameterNames);
        ...
        checkParameterList(parameterNames, parameterArray.getParameterNames());
        return paramRow;
    }

    /**
     * This method compares the parameterReferenceNames coming from the test class and the generated parameterNames coming from the data feeders.
     * If there is a diff between them, it is possible to
     * - do nothing                                             = Environment.GEPARD_PARAMNAME_CHECK is 0 or missing
     * - WARN the user by logging the problem to std out.       = Environment.GEPARD_PARAMNAME_CHECK is 1
     * - EXIT from Gepard to prevent bad parameter usage.          = Environment.GEPARD_PARAMNAME_CHECK is 2
     * <p/>
     * WARNING, this is not yet implemented!
     *
     * @param parameterReferenceNames is the input parameter string array
     * @param parameterNames          is the parameter names generated by the Feeder classes
     */
    private void checkParameterList(final String[] parameterReferenceNames, final String[] parameterNames) {
        // TODO Auto-generated method stub
        //exit code 44 is reserved for this.
    }
